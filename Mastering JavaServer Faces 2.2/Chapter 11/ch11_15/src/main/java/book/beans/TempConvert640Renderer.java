...
@ResourceDependencies({
    @ResourceDependency(name = "css/Device640.css", library = "default", target = "head"),
    @ResourceDependency(name = "jsf.js", library = "javax.faces", target = "body")
})
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = TempConvert640Renderer.RENDERER_TYPE)
public class TempConvert640Renderer extends Renderer {

    public static final String RENDERER_TYPE = "book.beans.TempConvert640Renderer";

    public TempConvert640Renderer() {
    }
