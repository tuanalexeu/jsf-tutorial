...
@ResourceDependencies({
    @ResourceDependency(name = "css/Device320.css", library = "default", target = "head"),
    @ResourceDependency(name = "jsf.js", library = "javax.faces", target = "body")
})
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = TempConvert320Renderer.RENDERER_TYPE)
public class TempConvert320Renderer extends Renderer {

    public static final String RENDERER_TYPE = "book.beans.TempConvert320Renderer";

    public TempConvert320Renderer() {
    }
    ...
    private void encodeResult(FacesContext context, TempConvertComponent component, String clientId) throws IOException {
        ...
        responseWriter.writeAttribute("class", "divs fonttemp", "class");
