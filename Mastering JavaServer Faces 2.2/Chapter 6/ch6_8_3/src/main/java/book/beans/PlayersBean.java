...
public class PlayersBean implements Serializable {
    ...
    public void setSelectedPlayer(ValueChangeEvent event) {      
        selectedPlayer = (Players) tableHashSet.getRowData();
    }

    public void showSelectedPlayer() {
        if (selectedPlayer != null) {
            logger.log(Level.INFO, "Selected player: {0}", selectedPlayer.getPlayer());
        } else {
