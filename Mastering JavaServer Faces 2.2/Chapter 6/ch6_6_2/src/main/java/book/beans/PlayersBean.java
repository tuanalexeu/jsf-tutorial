...
public class PlayersBean implements Serializable {
    ...
    public LinkedHashSet<Players> getDataHashSet() {
        return dataHashSet;
    }

    public void setDataHashSet(LinkedHashSet<Players> dataHashSet) {
        this.dataHashSet = dataHashSet;
    }

    public LinkedHashMap<String, Players> getDataHashMap() {
        return dataHashMap;
    }

    public void setDataHashMap(LinkedHashMap<String, Players> dataHashMap) {
